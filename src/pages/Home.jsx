    ...
    <nav className={`hm-nav ${scrolled ? "scrolled" : ""}`}>
      <div className="hm-nav-inner">
        <div className="hm-nav-brand">
          <img src={brandlogo} alt="Perfect Body" className="hm-nav-logo" />
          <span className="hm-nav-name">Perfect <em>Body</em></span>
        </div>
        ...
        <div className="hm-nav-actions">
          <button className="hm-btn-ghost" onClick={() => navigate("/Login")}>Log in</button>
          <button className="hm-btn-primary" onClick={() => navigate("/Signup")}>Get Started</button>
        </div>
      </div>
    </nav>
  );
    ...
    <section className="hm-hero">
      ...
      <div className="hm-hero-content">
        ...
        <div className="hm-hero-cta">
          <button className="hm-btn-primary hm-btn-lg" onClick={() => navigate("/dashboard")}>
            Get Started Free &nbsp;→
          </button>
          <button className="hm-btn-outline hm-btn-lg">
            Learn More
          </button>
        </div>
...
const testimonials = [
  {
    stars: 5,
    quote: "Perfect Body completely changed my relationship with food. The AI tracking is so easy!",
    name: "Sarah M.",
    role: "Lost 12kg in 3 months",
  },
  {
    stars: 5,
    quote: "The personalized meal plans during Ramadan were a game changer for me.",
    name: "Ahmed K.",
    role: "Fitness Enthusiast",
  },
  {
    stars: 5,
    quote: "I recommend Perfect Body to all my patients. The platform makes tracking effortless.",
    name: "Dr. Fatima L.",
    role: "Nutritionist",
  },
];
          ...
          {plans.map((p, i) => (
            ...
            >
              ...
              <ul className="hm-plan-features">
                {p.features.map((f, j) => (
                  <li key={j}>
                    <span className="hm-check">✓</span> {f}
                  </li>
                ))}
              </ul>
              <button className={`hm-plan-btn ${p.popular ? "hm-plan-btn-primary" : "hm-plan-btn-outline"}`}>
                Choose Plan
              </button>
            </div>
          ))}
